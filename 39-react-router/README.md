...
### Benefits
- we only have the one initial frontend load (which is hopefully now slow)

### Challenges  just localhost:3000 (or just reddit.com)
- can't reload and stay on the same view 
- can't share links to friends 
- can't use navigation 
- can't bookmark
- user analytics are impossible (what pages they visit, for how long, bounce time)
- UI is WEIRD
